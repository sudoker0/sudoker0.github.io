...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 201 files | 287,542,710 bytes
\* | 0.01% | 12 files | 20,794 bytes
\*.config | 0.03% | 1 files | 82,580 bytes
\*.css | 0.01% | 5 files | 17,137 bytes
\*.gif | 0.0% | 1 files | 10,498 bytes
\*.html | 0.19% | 32 files | 539,732 bytes
\*.ico | 0.04% | 2 files | 118,934 bytes
\*.idx | 0.09% | 1 files | 260,408 bytes
\*.jpg | 0.0% | 1 files | 5,529 bytes
\*.js | 0.02% | 7 files | 68,079 bytes
\*.json | 0.12% | 10 files | 359,254 bytes
\*.map | 0.03% | 11 files | 75,707 bytes
\*.md | 0.0% | 3 files | 7,676 bytes
\*.mp3 | 0.0% | 1 files | 9,069 bytes
\*.old | 0.19% | 2 files | 553,570 bytes
\*.pack | 95.7% | 1 files | 275,172,822 bytes
\*.png | 2.12% | 36 files | 6,102,973 bytes
\*.pug | 0.02% | 8 files | 44,427 bytes
...
\*.ts | 0.03% | 7 files | 75,725 bytes
\*.ttf | 0.28% | 4 files | 819,080 bytes
