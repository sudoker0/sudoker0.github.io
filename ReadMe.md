...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 191 files | 447,142,517 bytes
...
\*.idx | 0.05% | 1 files | 206,228 bytes
\*.js | 0.01% | 8 files | 43,846 bytes
\*.json | 0.06% | 7 files | 263,854 bytes
\*.md | 0.0% | 1 files | 8,671 bytes
\*.pack | 58.17% | 1 files | 260,094,252 bytes
