...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 191 files | 446,967,023 bytes
...
\*.html | 0.16% | 37 files | 718,688 bytes
\*.ico | 0.02% | 1 files | 101,976 bytes
\*.idx | 0.05% | 1 files | 207,600 bytes
\*.js | 0.01% | 8 files | 46,370 bytes
\*.json | 0.06% | 7 files | 265,133 bytes
\*.md | 0.0% | 1 files | 8,688 bytes
\*.pack | 58.15% | 1 files | 259,916,368 bytes
