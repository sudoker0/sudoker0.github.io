...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 173 files | 285,420,070 bytes
...
\*.idx | 0.08% | 1 files | 241,676 bytes
\*.js | 0.02% | 6 files | 65,521 bytes
\*.json | 0.1% | 10 files | 298,761 bytes
\*.map | 0.03% | 10 files | 74,183 bytes
\*.md | 0.0% | 4 files | 9,465 bytes
\*.mp3 | 0.0% | 1 files | 9,069 bytes
\*.old | 0.19% | 2 files | 553,570 bytes
\*.pack | 96.51% | 1 files | 275,469,495 bytes
