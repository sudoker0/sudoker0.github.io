...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 174 files | 445,902,340 bytes
...
\*.idx | 0.04% | 1 files | 189,428 bytes
\*.js | 0.03% | 11 files | 138,603 bytes
\*.json | 0.05% | 7 files | 243,231 bytes
\*.md | 0.0% | 1 files | 7,720 bytes
\*.pack | 58.04% | 1 files | 258,797,239 bytes
