...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 173 files | 445,905,736 bytes
\* | 0.0% | 13 files | 17,350 bytes
...
\*.idx | 0.04% | 1 files | 190,156 bytes
\*.js | 0.03% | 11 files | 134,850 bytes
\*.json | 0.05% | 7 files | 244,316 bytes
\*.md | 0.0% | 1 files | 7,720 bytes
\*.pack | 58.04% | 1 files | 258,803,483 bytes
