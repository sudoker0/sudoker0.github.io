...
----------------|--------------------- |-----------------|--------------------------
\*\* | 100.0% | 0 files | 14,275,686 bytes
\* | 0.14% | 13 files | 20,209 bytes
...
\*.json | 0.66% | 6 files | 94,117 bytes
