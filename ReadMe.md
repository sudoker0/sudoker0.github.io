...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 160 files | 233,102,551 bytes
...
\*.idx | 0.07% | 1 files | 170,360 bytes
\*.js | 0.05% | 9 files | 113,778 bytes
\*.json | 0.09% | 7 files | 220,782 bytes
\*.md | 0.0% | 1 files | 7,483 bytes
\*.pack | 54.3% | 1 files | 126,584,018 bytes
