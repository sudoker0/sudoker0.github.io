...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 172 files | 446,045,788 bytes
\* | 0.0% | 13 files | 17,266 bytes
\*.7z | 35.64% | 16 files | 158,965,963 bytes
\*.config | 0.02% | 1 files | 82,580 bytes
\*.css | 0.01% | 4 files | 26,297 bytes
\*.gif | 0.0% | 1 files | 10,498 bytes
\*.html | 0.16% | 31 files | 698,708 bytes
\*.ico | 0.02% | 1 files | 101,976 bytes
\*.idx | 0.04% | 1 files | 185,312 bytes
\*.js | 0.03% | 11 files | 131,522 bytes
\*.json | 0.05% | 7 files | 239,246 bytes
\*.md | 0.0% | 1 files | 7,486 bytes
\*.pack | 58.06% | 1 files | 258,968,842 bytes
