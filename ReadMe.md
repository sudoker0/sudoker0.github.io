...
----------------|--------------------- |-----------------|--------------------------
\** | 100.0% | 219 files | 294,386,694 bytes
\* | 0.01% | 12 files | 23,000 bytes
\*.config | 0.03% | 1 files | 82,580 bytes
\*.css | 0.01% | 6 files | 19,828 bytes
\*.gif | 0.16% | 2 files | 477,306 bytes
\*.html | 0.18% | 33 files | 543,591 bytes
\*.ico | 0.05% | 3 files | 133,332 bytes
\*.idx | 0.09% | 1 files | 267,520 bytes
\*.jpg | 0.2% | 2 files | 594,004 bytes
\*.js | 0.02% | 8 files | 72,345 bytes
\*.json | 0.13% | 10 files | 370,047 bytes
\*.map | 0.03% | 13 files | 81,290 bytes
\*.md | 0.0% | 3 files | 7,052 bytes
\*.mp3 | 0.0% | 1 files | 9,069 bytes
\*.old | 0.19% | 2 files | 553,570 bytes
\*.pack | 94.54% | 1 files | 278,325,763 bytes
\*.png | 2.78% | 37 files | 8,169,570 bytes
\*.pug | 0.02% | 10 files | 46,904 bytes
...
\*.svg | 0.05% | 26 files | 147,909 bytes
\*.ts | 0.03% | 8 files | 80,334 bytes
