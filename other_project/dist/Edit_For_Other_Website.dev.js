...
function initialize_editor(parentId, acceptRisk) {
  //Just like the name of the funtion, it initialize the editor
  if (acceptRisk) {
    //Check if the user have accept the risk (You should read the risk first before initialize the editor)
    if (!!document.getElementById(parentId)) {
      //Check if the id that the user provided exist or not
      if (!document.getElementsByClassName("moNndhEOCbPJu65PiwZQ0L2N0QFMkp4zpHawfJIY6c7R7AY4MJK0oVKY2CelpMou")[0]) {
        //Check if edit has already been initialized
...
function close_editor() {
  var edit_1 = document.querySelector("#editor");
...
function dragElement1(elmnt1) {
  ...
  function dragMouseDown1(e) {
    ...
    pos3_1 = e.clientX;
    pos4_1 = e.clientY;
    document.onmouseup = closeDragElement1; // call a function whenever the cursor moves:
  ...
  function elementDrag1(e) {
    ...
    pos3_1 = e.clientX;
    pos4_1 = e.clientY; // set the element's new position:

    test_1_1 = elmnt1.offsetTop - pos2_1;
    test_2_1 = elmnt1.offsetLeft - pos1_1;

    if (test_2_1 <= 0 || test_1_1 <= 0 || window.innerWidth - 757 < test_2_1 || window.innerHeight - 557 < test_1_1) {} else {
...
function editor_gotoline() {
  var open = document.querySelector("#editor_gotoline");
...
function editor_replace() {
  var open = document.querySelector("#editor_replace");
  open.style.display = "block";
  document.querySelector("#editor_overlay").style.display = "block";
}
...
function editor_open() {
  var open = document.querySelector("#editor_open");
  open.style.display = "block";
  document.querySelector("#editor_overlay").style.display = "block";
}
...
function editor_save() {
  var save = document.querySelector("#editor_save");
