...
*/
function initialize_editor(parentId, acceptRisk) { //Just like the name of the funtion, it initialize the editor
    if (acceptRisk) { //Check if the user have accept the risk (You should read the risk first before initialize the editor)
        if (!!document.getElementById(parentId)) { //Check if the id that the user provided exist or not
            if (!document.getElementsByClassName("moNndhEOCbPJu65PiwZQ0L2N0QFMkp4zpHawfJIY6c7R7AY4MJK0oVKY2CelpMou")[0]) { //Check if edit has already been initialized
